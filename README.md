# [Применение Luigi для создания пайплайна скачивания и обработки данных](https://github.com/Ursekov/MIPT_SF_DATA_SCIENCE/tree/main/Project%200)
...
Код находится в файле с расширением .py под названием [Luigi Pipeline](https://github.com/Ursekov/HH-Data-Processing/blob/master/HH_Data_Processing.ipynb)

Список используемых пакетов среды находится в файле [requirements.txt](df)
